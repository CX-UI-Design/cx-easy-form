...
export default [
  ...
  //验证 Mobilephone
  {
    ...
    // ruleReg: /^((\(\d{3}\))|(\d{3}\-))?13[0-9]\d{8}|14[57]\d{8}|15[0-9]\d{8}|18[0-9]\d{8}|19[8]\d{7}$/
    //国内手机,所有格式：13-9（0-9）
    // ruleReg: /^((\(\d{3}\))|(\d{3}\-))?13[0-9]\d{8}|14[0-9]\d{8}|15[0-9]\d{8}|16[0-9]\d{8}|17[0-9]\d{8}|18[0-9]\d{7}|19[0-9]\d{7}$/,
    // ruleReg: /^1[3|4|5|7|8][0-9]{8}$/
    ruleReg: /^1[3|4|5|8][0-9]\d{8}$/,
  },
